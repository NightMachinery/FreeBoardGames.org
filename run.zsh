...
WEB_CMD="export CODENAMES_PICTURES_DIR=${CODENAMES_PICTURES_DIR:-$DEFAULT_CODENAMES_PICTURES_DIR}; $WEB_CMD"
BGIO_CMD="export CODENAMES_PICTURES_DIR=${CODENAMES_PICTURES_DIR:-$DEFAULT_CODENAMES_PICTURES_DIR}; $BGIO_CMD"
BACKEND_CMD="export CODENAMES_PICTURES_DIR=${CODENAMES_PICTURES_DIR:-$DEFAULT_CODENAMES_PICTURES_DIR}; $BACKEND_CMD"
