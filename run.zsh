...
if ! command -v avifenc >/dev/null 2>&1 || ! command -v convert >/dev/null 2>&1; then
  echo "Warning: Secret Codes picture mode now expects avifenc + convert on the host. Run ./prepare_once.zsh to install them." >&2
fi
...
WEB_CMD="export CODENAMES_PICTURES_DIR=${CODENAMES_PICTURES_DIR:-$DEFAULT_CODENAMES_PICTURES_DIR}; export FBG_IMAGES_CACHE_DIR=${FBG_IMAGES_CACHE_DIR:-$DEFAULT_FBG_IMAGES_CACHE_DIR}; $WEB_CMD"
BGIO_CMD="export CODENAMES_PICTURES_DIR=${CODENAMES_PICTURES_DIR:-$DEFAULT_CODENAMES_PICTURES_DIR}; export FBG_IMAGES_CACHE_DIR=${FBG_IMAGES_CACHE_DIR:-$DEFAULT_FBG_IMAGES_CACHE_DIR}; $BGIO_CMD"
BACKEND_CMD="export CODENAMES_PICTURES_DIR=${CODENAMES_PICTURES_DIR:-$DEFAULT_CODENAMES_PICTURES_DIR}; export FBG_IMAGES_CACHE_DIR=${FBG_IMAGES_CACHE_DIR:-$DEFAULT_FBG_IMAGES_CACHE_DIR}; $BACKEND_CMD"
