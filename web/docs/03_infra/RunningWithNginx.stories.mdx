...
- pnpm: install pnpm 10.x (for example, `corepack prepare pnpm@10.33.2 --activate`)
...
`cd FreeBoardgames.org && pnpm install`

Run dev:

`BGIO_PUBLIC_SERVERS=https://your.domain pnpm run dev checkers`
